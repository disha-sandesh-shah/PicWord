...
import com.example.picword.Adapter.GridViewSuggestAdapterSet6;
...
public class Set6Activity extends AppCompatActivity {

    public List<String> suggestSource = new ArrayList<>();
    public GridView answerAdapter;
    public GridViewSuggestAdapterSet6 suggestAdapter;
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(result.equals(correct_answer)) {
                    ...
                    GridViewSuggestAdapterSet6 suggestAdapter = new GridViewSuggestAdapterSet6(suggestSource, getApplicationContext(), Set6Activity.this);
                    gridViewSuggest.setAdapter(suggestAdapter);
                    suggestAdapter.notifyDataSetChanged();

                } else {
                    Toast.makeText(Set6Activity.this, "Incorrect !!", Toast.LENGTH_SHORT).show();
                }
                setupList();
    ...
    private void setupList() {
        ...
        suggestAdapter = new GridViewSuggestAdapterSet6(suggestSource, this, this);
