...
public class Set2Activity extends AppCompatActivity {
    ...
    public GridViewSuggestAdapterSet2 suggestAdapter;
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(result.equals(correct_answer)) {
                    ...
                    GridViewSuggestAdapterSet2 suggestAdapter = new GridViewSuggestAdapterSet2(suggestSource, getApplicationContext(), Set2Activity.this);
                    gridViewSuggest.setAdapter(suggestAdapter);
                    suggestAdapter.notifyDataSetChanged();

                } else {
                    Toast.makeText(Set2Activity.this, "Incorrect !!", Toast.LENGTH_SHORT).show();
                }
                setupList();
    ...
    private void setupList() {
        ...
        suggestAdapter = new GridViewSuggestAdapterSet2(suggestSource, this, this);
