        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(result.equals(correct_answer)) {
                    ...
                    GridViewSuggestAdapter suggestAdapter = new GridViewSuggestAdapter(suggestSource, getApplicationContext(), Set1Activity.this);
                    gridViewSuggest.setAdapter(suggestAdapter);
                    suggestAdapter.notifyDataSetChanged();

                } else {
                    Toast.makeText(Set1Activity.this, "Incorrect !!", Toast.LENGTH_SHORT).show();
                }
                setupList();
