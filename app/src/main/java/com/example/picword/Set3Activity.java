...
import com.example.picword.Adapter.GridViewSuggestAdapterSet3;
...
public class Set3Activity extends AppCompatActivity {
    ...
    public GridViewSuggestAdapterSet3 suggestAdapter;
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(result.equals(correct_answer)) {
                    ...
                    GridViewSuggestAdapterSet3 suggestAdapter = new GridViewSuggestAdapterSet3(suggestSource, getApplicationContext(), Set3Activity.this);
                    gridViewSuggest.setAdapter(suggestAdapter);
                    suggestAdapter.notifyDataSetChanged();

                } else {
                    Toast.makeText(Set3Activity.this, "Incorrect !!", Toast.LENGTH_SHORT).show();
                }
                setupList();
    ...
    private void setupList() {
        ...
        suggestAdapter = new GridViewSuggestAdapterSet3(suggestSource, this, this);
