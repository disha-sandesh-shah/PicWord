...
public class Set4Activity extends AppCompatActivity {
    ...
    public GridViewSuggestAdapterSet4 suggestAdapter;
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(result.equals(correct_answer)) {
                    ...
                    GridViewSuggestAdapterSet4 suggestAdapter = new GridViewSuggestAdapterSet4(suggestSource, getApplicationContext(), Set4Activity.this);
                    gridViewSuggest.setAdapter(suggestAdapter);
                    suggestAdapter.notifyDataSetChanged();

                } else {
                    Toast.makeText(Set4Activity.this, "Incorrect !!", Toast.LENGTH_SHORT).show();
                }
                setupList();
    ...
    private void setupList() {
        ...
        suggestAdapter = new GridViewSuggestAdapterSet4(suggestSource, this, this);
